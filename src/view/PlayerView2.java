...
import model.Bullet2;

public class PlayerView2 extends ImageView {
	...
	public boolean zombiesdie = false;
	public int number;
	
	ArrayList<Bullet2> bullets = new ArrayList<>();
	...
	public PlayerView2(Pane pane,ArrayList<Zombies> zombies,ArrayList<ZombiesView2> zombiesView,int scores, boolean s) {
	...
	public void shoot(Player who) {
		...
		Bullet2 bullet = new Bullet2(who,width,height,direction);
	...
	public void update() {	    
		if (down) {
			...
			if (direction == Direction.DOWN && netPlayScene.DOWN == false) {
			...
			if (direction == Direction.UP && netPlayScene.UP == false) {
			...
			if (direction == Direction.LEFT && netPlayScene.LEFT == false) {
			...
			if (direction == Direction.RIGHT && netPlayScene.RIGHT == false) {
