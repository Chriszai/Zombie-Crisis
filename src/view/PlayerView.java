...
public class PlayerView extends ImageView {
	...
	ArrayList<ZombiesView> zombiesView;
	Direction d = null;
	public double[] offx;
	public double[] offy;
	...
	public PlayerView(Pane pane, ArrayList<Zombies> zombies, ArrayList<ZombiesView> zombiesView, int scores) {
	...
	public void shoot(Player who) {
		Bullet bullet = new Bullet(who, width, height, direction);
